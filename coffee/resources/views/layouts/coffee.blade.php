...
<head>
    ...
    <link href="{{ asset('css/cottom.css') }}" rel="stylesheet">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav  bg-primary sidebar sidebar-dark accordion" id="accordionSidebar" >
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                <div class="sidebar-brand-icon rotate-n-15 position-relative">
                    {{-- <i class="bi bi-cloud-haze-fill"></i> --}}
                    <img src="https://www.transparentpng.com/thumb/unicorn/I5APeU-unicorn-cute-unicorn-svg-cut-file-scrapbook-cut-file-cute.png" alt="" style=" width: 47px; height: 47px; position:absolute; top:0px position: absolute;
                    top: -25px;
                    left: -33px;
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow mx-1">
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item text-center small text-gray-500" href="#">ดูความคิดเห็นทั้งหมด</a>
                            </div>
                        </li>
                ...
                <!-- Begin Page Content -->
               <div style="margin-bottom: 11rem">@yield('content')</div>
                <!-- /.container-fluid -->
